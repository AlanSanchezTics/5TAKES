  ...
  <table class="table table-striped">
    ...
    while ($reg = mysqli_fetch_array($result)) {
      echo '<tr>
        ...
        <td><a href="modDatos.php"><button type="button" class="btn btn-warning">Modificar</button></a><a href="inactiveUser.php?usuID='.$reg[0].'"><button type="button" class="btn btn-danger">Eliminar</button></a></td>
              </tr>';
    }
    ?>
    </tbody>
